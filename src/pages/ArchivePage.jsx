...
import neighborsImg from "../assets/neighbors-in-need.jpg"; // ADD THIS IMAGE TO /assets
...
export default function ArchivePage() {
  ...
  const resources = [
    ...
    },
    {
      ...
      img: neighborsImg,
      desc: "A grassroots support network providing groceries, rides, and mutual aid to Coppell families.",
    },
  ];
    ...
    <div className="page archive">
      ...
      <div className="slab reveal fade-in-up" style={{ marginBottom: "3rem" }}>
        ...
        <p className="lead" style={{ marginTop: "1rem" }}>
          The Coppell Community Archive preserves the stories, organizations,
          and cultural foundations that shape our city. By documenting local
          projects—from Metrocrest Services to NoteLove and neighborhood-led
          initiatives like Neighbors In Need—we create a living record of
          community support, resilience, and shared history. This archive ensures
          future generations understand the people and groups who strengthened
          Coppell.
        </p>
      </div>
