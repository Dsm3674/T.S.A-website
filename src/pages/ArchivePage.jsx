...
export default function ArchivePage() {
  ...
  // 🔹 FIX: ensure archive cards become visible after search/filter updates
  // This preserves your reveal animation system without removing it
  useEffect(() => {
  ...
  return (
    <div className="page archive-page">
      ...
      <section
        ...
        style={{ marginTop: "4rem", background: "var(--bg)" }}
      >
